...
<p style="color:blue">Ou on fait juste le laisser à -999?</p> 

![](../inst/img/wet_cl_cmj.png)

Les variables qui possèdent moins de 1% de valeurs manquantes sont tous des variables liées à la constitution du sol :

- Proportion de sable 
- Proportion d'argile
- Proportion de limon
- Quantité moyenne de carbone dans les 5 premiers centimètres de sol

Nous remarquons que ce sont les mêmes observations qui sont manquantes au travers les 4 variables.

<p style="color:blue">Est-ce qu'on pourrait ajouter l'information géographique pour faire de l'interpolation??</p> 
