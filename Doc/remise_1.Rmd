...
shape_file_path <- "../Data/RiverATLAS_Data_v10_shp/RiverATLAS_v10_shp/RiverATLAS_v10_na.shp"
...
Comme le calcul du débit d'eau dans un lac n'a pas vraiment de sens, on peut simplement retirer ces observations du jeu de données.
