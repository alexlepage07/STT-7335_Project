...
- Même variance au travers les différentes rivières et aucune covariance entre les différentes rivières
...
... \\
0 ~ 0 ~ 0~ ... ~ \sigma^2\\
\end{bmatrix}_{3844 \times 3844}$$

- Différentes variances au travers les différentes rivières et aucune covariance entre les différentes rivières
