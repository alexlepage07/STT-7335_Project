...
Après avoir décomposé l'EQM, on s'aperçoit que le biais vaut approximatiement 0. Ainsi, on peut en conclure que le modèle ajusté est non biaisé pour nos données.
